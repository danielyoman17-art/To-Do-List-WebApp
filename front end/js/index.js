...
let allTask = [{"text":"sometext","isComplete":false},{"text":"sometext","isComplete":false},{"text":"sometext","isComplete":false}]
updateTask('all')
...
function updateTask(state){
    taskList.innerHTML = '';
    let taskUpdating = allTask;
    if (state == 'complete'){
        taskUpdating = allTask.filter((task)=> task.isCompleted===true)
    }else if (state == 'uncomplete'){
        taskUpdating = allTask.filter((task)=> task.isCompleted===false)
    }
...
function deleteTask(index){
    allTask = allTask.filter((_,i)=> i!==index);
    updateTask(taskCategory);
}
